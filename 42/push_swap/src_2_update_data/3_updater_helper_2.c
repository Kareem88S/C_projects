...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   3_updater_helper_2.c                               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: kasherif <kasherif@student.codam.nl>       +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/06/14 11:45:07 by kasherif          #+#    #+#             */
/*   Updated: 2025/06/28 00:19:05 by kasherif         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	update_nodes(t_stack_status *s)
{
	...
	while (++index < s->stack_size)
	{
		...
		n->n_stats.belongs_in_quarter = (rel_val * 4) / s->stack_size;
		n->n_stats.belongs_in_quarter_rev = (rel_rev * 4) / s->stack_size;
		n->n_stats.belongs_in_tenth = (rel_val * 10) / s->stack_size;
		n->n_stats.belongs_in_tenth_rev = (rel_rev * 10) / s->stack_size;
		n->n_stats.in_which_quarter = (index * 4) / s->stack_size;
		n->n_stats.in_which_tenth = (index * 10) / s->stack_size;
		n = n->previous;
	}
